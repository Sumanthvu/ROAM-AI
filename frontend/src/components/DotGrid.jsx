...
const DotGrid = ({
  dotSize = 3, // Smaller dots for a subtle look
  gap = 25,
  baseColor = '#334155', // Slate-700 for dark mode
  activeColor = '#a78bfa', // Light Purple for interaction
  proximity = 120,
  shockRadius = 250,
  shockStrength = 2,
  resistance = 750,
    ...
    const onClick = e => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (dist < shockRadius && !dot._inertiaApplied) {
          ...
          gsap.to(dot, { inertia: { xOffset: pushX, yOffset: pushY, resistance }, onComplete: () => {
