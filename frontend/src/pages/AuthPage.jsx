...
import "./AuthPage.css";
import DarkVeil from "../components/DarkVeil"; // Make sure this path is correct
...
export default function AuthPage() {
  ...
  return (
    // Parent container for the background and the content
    <div style={{
        position: 'relative',
        width: '100vw',
        height: '100vh',
        ...
        {/* Centering container for the auth box */}
        <div style={{
            position: 'relative',
            zIndex: 1,
            width: '85%',
            ...
            {/* The original auth box structure */}
            <div style={{
                position: 'relative',
                width: '70%',
                maxWidth: '1100px',
                ...
                <div style={{
                    ...
                    height: '100%',
                    borderRadius: '5px',
                    border: '0.8px solid rgb(0, 212, 255)',
                    overflow: 'hidden',
                    backgroundColor: 'rgb(10, 22, 40)', // Restored solid background
                    ...
                    <div style={{
                            ...
                            <div style={{ width: '85%', maxWidth: '400px', paddingBottom: '2rem' }}>
                                ...
                                <form onSubmit={handleRegisterSubmit} style={{
                                    ...
                                    <button
                                        ...
                                        style={{
                                            width: '100%',
                                            backgroundColor: 'rgba(48, 160, 240, 1)',
                                            color: 'rgb(15, 23, 42)',
                                            fontWeight: '700',
                                            padding: '0.75rem',
                                            borderRadius: '9999px',
                        ...
                        <div style={{
                            ...
                            width: '50%',
                            height: '100%',
                            background: 'linear-gradient(135deg, rgba(57, 151, 170, 1), rgba(47, 6, 212, 1))',
                            transition: 'all 700ms cubic-bezier(0.4, 0, 0.2, 1)',
...
//         height: '100%',
//         borderRadius: '4px',
//         border: '1px solid rgba(56, 142, 159, 1)',
//         overflow: 'hidden',
